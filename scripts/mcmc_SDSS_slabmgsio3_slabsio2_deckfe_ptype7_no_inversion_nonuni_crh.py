...
do_clouds=1
npatches=1
cloudname = ['Mie scattering cloud slab--MgSiO3','Mie scattering cloud slab--SiO2_WS15', 'Mie scattering cloud deck--Fe']  
...
io_config_instance.outdir="/beegfs/general/viktoria/brewster_v2/SDSS_results/mcmc_SDSS_slabmgsio3_slabsio2_deckfe_ptype7_no_inversion_nonuni_crh/"
io_config_instance.runname='mcmc_SDSS_slabmgsio3_slabsio2_deckfe_ptype7_no_inversion_nonuni_crh'
...
re_params.dictionary['cloud']['patch 1']['Mie scattering cloud slab--SiO2_WS15']['params']['logp_mcs_SiO2_WS15']['distribution']=['normal',-3.7,0.03]
re_params.dictionary['cloud']['patch 1']['Mie scattering cloud slab--SiO2_WS15']['params']['dp_mcs_SiO2_WS15']['distribution']=['normal',0.54,0.3]
re_params.dictionary['cloud']['patch 1']['Mie scattering cloud slab--SiO2_WS15']['params']['hansan_a_mcs_SiO2_WS15']['distribution']=['normal',-0.8,0.2]
re_params.dictionary['cloud']['patch 1']['Mie scattering cloud slab--SiO2_WS15']['params']['hansan_b_mcs_SiO2_WS15']['distribution']=['normal',0.69,0.2]
re_params.dictionary['cloud']['patch 1']['Mie scattering cloud slab--MgSiO3']['params']['logp_mcs_MgSiO3']['distribution']=['normal',-3.7,0.3]
re_params.dictionary['cloud']['patch 1']['Mie scattering cloud slab--MgSiO3']['params']['dp_mcs_MgSiO3']['distribution']=['normal',0.54,0.3]
re_params.dictionary['cloud']['patch 1']['Mie scattering cloud slab--MgSiO3']['params']['hansan_a_mcs_MgSiO3']['distribution']=['normal',-0.8,0.2]
re_params.dictionary['cloud']['patch 1']['Mie scattering cloud slab--MgSiO3']['params']['hansan_b_mcs_MgSiO3']['distribution']=['normal',0.69,0.2]
