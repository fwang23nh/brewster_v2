...
io_config_instance.outdir="/beegfs/general/viktoria/brewster_v2/GJ499C_results/mcmc_GJ_slabsio_slabmgsio3_deckfe_ptype7_nonuni_crh/"
io_config_instance.runname='mcmc_GJ_slabsio_slabmgsio3_deckfe_ptype7_nonuni_crh'
...
re_params.dictionary['pt']['params']['Tint']['distribution']=['normal', 2200,300]
...
re_params.dictionary['pt']['params']['T1']['distribution']=['normal', 450,300]
re_params.dictionary['pt']['params']['T2']['distribution']=['normal', 400,300]
re_params.dictionary['pt']['params']['T3']['distribution']=['normal', 1200,300]
