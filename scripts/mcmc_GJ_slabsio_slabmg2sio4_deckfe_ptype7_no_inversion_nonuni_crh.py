...
io_config_instance.outdir="/beegfs/general/viktoria/brewster_v2/GJ499C_results/mcmc_GJ_slabsio_slabmg2sio4_deckfe_ptype7_no_inversion_nonuni_crh/"
io_config_instance.runname='mcmc_GJ_slabsio_slabmg2sio4_deckfe_ptype7_no_inversion_nonuni_crh'
...
re_params.dictionary['cloud']['patch 1']['Mie scattering cloud slab--Mg2SiO4']['params']['logp_mcs_Mg2SiO4']['distribution']=['normal',-3.5,0.5]
...
re_params.dictionary['cloud']['patch 1']['Mie scattering cloud slab--SiO']['params']['logp_mcs_SiO']['distribution']=['normal',-3.5,0.5]
