...
do_clouds=1
npatches=1
cloudname = ['Mie scattering cloud slab--SiO','Mie scattering cloud slab--SiO2_WS15' ,'Mie scattering cloud deck--Fe']  
...
io_config_instance.outdir="/beegfs/general/viktoria/brewster_v2/GJ499C_results/mcmc_GJ_slabsio_slabsio2_deckfe_ptype7_no_inversion_nonuni_crh/"
io_config_instance.runname='mcmc_GJ_slabsio_slabsio2_deckfe_ptype7_no_inversion_nonuni_crh'
...
re_params.dictionary['gas']['co']['params']['log_abund']['distribution']=['normal', -2.8,0.5]
re_params.dictionary['gas']['co2']['params']['log_abund']['distribution']=['normal',-4.8,0.5]
re_params.dictionary['gas']['ch4']['params']['log_abund']['distribution']=['normal',-5.2,0.5]
re_params.dictionary['gas']['sio']['params']['log_abund']['distribution']=['normal',-5.0,0.5]
re_params.dictionary['gas']['tio']['params']['log_abund']['distribution']=['normal',-10.3,0.5]
re_params.dictionary['gas']['vo']['params']['log_abund']['distribution']=['normal',-8.8,0.5]
re_params.dictionary['gas']['crh']['params']['log_abund']['distribution']=['normal',-8.3,0.5]
re_params.dictionary['gas']['feh']['params']['log_abund']['distribution']=['normal',-7.8,0.5]
...
#re_params.dictionary['pt']['params']['Tint']['distribution']=['normal', 1000,200]
...
#re_params.dictionary['pt']['params']['T1']['distribution']=['normal', 690,200]
#re_params.dictionary['pt']['params']['T2']['distribution']=['normal', 765,200]
#re_params.dictionary['pt']['params']['T3']['distribution']=['normal', 835,200]
re_params.dictionary['cloud']['patch 1']['Mie scattering cloud slab--SiO']['params']['logp_mcs_SiO']['distribution']=['normal',-3.5,0.2]
re_params.dictionary['cloud']['patch 1']['Mie scattering cloud slab--SiO2_WS15']['params']['logp_mcs_SiO2_WS15']['distribution']=['normal',-3.5,0.2]
