...
io_config_instance.outdir="/beegfs/general/viktoria/brewster_v2/SDSS_results/mcmc_SDSS_slabmgsio3_slabmg2sio4_deckfe_ptype7_no_inversion_nonuni_crh/"
io_config_instance.runname='mcmc_SDSS_slabmgsio3_slabmg2sio4_deckfe_ptype7_no_inversion_nonuni_crh'
...
re_params.dictionary['cloud']['patch 1']['Mie scattering cloud slab--Mg2SiO4']['params']['logp_mcs_Mg2SiO4']['distribution']=['normal',-3.7,0.3]
re_params.dictionary['cloud']['patch 1']['Mie scattering cloud slab--Mg2SiO4']['params']['dp_mcs_Mg2SiO4']['distribution']=['normal',0.54,0.3]
re_params.dictionary['cloud']['patch 1']['Mie scattering cloud slab--Mg2SiO4']['params']['hansan_a_mcs_Mg2SiO4']['distribution']=['normal',-0.8,0.2]
re_params.dictionary['cloud']['patch 1']['Mie scattering cloud slab--Mg2SiO4']['params']['hansan_b_mcs_Mg2SiO4']['distribution']=['normal',0.69,0.2]
