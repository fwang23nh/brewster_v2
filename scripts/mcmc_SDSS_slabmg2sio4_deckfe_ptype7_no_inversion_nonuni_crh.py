...
do_clouds=1
npatches=1
cloudname = ['Mie scattering cloud slab--Mg2SiO4', 'Mie scattering cloud deck--Fe']  
...
io_config_instance.outdir="/beegfs/general/viktoria/brewster_v2/SDSS_results/mcmc_SDSS_slabmg2sio4_deckfe_ptype7_no_inversion_nonuni_crh/"
io_config_instance.runname='mcmc_SDSS_slabmg2sio4_deckfe_ptype7_no_inversion_nonuni_crh'
...
re_params.dictionary['gas']['co2']['params']['log_abund']['distribution']=['normal',-5.5,0.5]
...
re_params.dictionary['gas']['tio']['params']['log_abund']['distribution']=['normal',-8.3,0.5]
...
re_params.dictionary['gas']['feh']['params']['log_abund']['distribution']=['normal',-8.0,0.5]
...
#re_params.dictionary['cloud']['patch 1']['Mie scattering cloud slab--MgSiO3']['params']['logp_mcs_MgSiO3']['distribution']=['normal',-3.5,0.5]
re_params.dictionary['cloud']['patch 1']['Mie scattering cloud slab--Mg2SiO4']['params']['logp_mcs_Mg2SiO4']['distribution']=['normal',-3.5,0.2]
re_params.dictionary['cloud']['patch 1']['Mie scattering cloud deck--Fe']['params']['dp_mcd_Fe']['distribution']=['normal', 0.2,0.1]
re_params.dictionary['pt']['params']['Tint']['distribution']=['normal', 1700,200]
re_params.dictionary['pt']['params']['alpha']['distribution']=['normal', 1.5,0.2]
re_params.dictionary['pt']['params']['lndelta']['distribution']=['normal', -2.0,0.5]
re_params.dictionary['pt']['params']['T1']['distribution']=['normal', 290,200]
re_params.dictionary['pt']['params']['T2']['distribution']=['normal', 365,200]
re_params.dictionary['pt']['params']['T3']['distribution']=['normal', 1035,200]
