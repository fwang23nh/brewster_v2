...
io_config_instance.outdir="/beegfs/general/viktoria/brewster_v2/SDSS_results/mcmc_SDSS_slabmgsio3_deckfe_ptype7_nonuni_crh/"
io_config_instance.runname='mcmc_SDSS_slabmgsio3_deckfe_ptype7_nonuni_crh'
...
re_params.dictionary['cloud']['patch 1']['Mie scattering cloud slab--MgSiO3']['params']['logp_mcs_MgSiO3']['distribution']=['normal',-3.7,0.2]
re_params.dictionary['cloud']['patch 1']['Mie scattering cloud slab--MgSiO3']['params']['dp_mcs_MgSiO3']['distribution']=['normal',0.54,0.2]
re_params.dictionary['cloud']['patch 1']['Mie scattering cloud slab--MgSiO3']['params']['hansan_a_mcs_MgSiO3']['distribution']=['normal',-0.8,0.1]
re_params.dictionary['cloud']['patch 1']['Mie scattering cloud slab--MgSiO3']['params']['hansan_b_mcs_MgSiO3']['distribution']=['normal',0.69,0.1]
