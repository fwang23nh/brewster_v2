...
io_config_instance.outdir="/beegfs/general/viktoria/brewster_v2/GJ499C_results/mcmc_GJ_slabmgsio3_deckfe_ptype7_nonuni_crh/"
io_config_instance.runname='mcmc_GJ_slabmgsio3_deckfe_ptype7_nonuni_crh'
...
re_params.dictionary['pt']['params']['Tint']['distribution']=['normal', 1200,200]
re_params.dictionary['pt']['params']['alpha']['distribution']=['normal', 0.80,0.1]
re_params.dictionary['pt']['params']['lndelta']['distribution']=['normal', 2.27,0.5]
re_params.dictionary['pt']['params']['T1']['distribution']=['normal', 850,200]
re_params.dictionary['pt']['params']['T2']['distribution']=['normal', 900,200]
re_params.dictionary['pt']['params']['T3']['distribution']=['normal', 960,200]
