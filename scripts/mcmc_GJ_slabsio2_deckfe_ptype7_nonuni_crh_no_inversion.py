...
do_clouds=1
npatches=1
cloudname = ['Mie scattering cloud slab--SiO2_WS15', 'Mie scattering cloud deck--Fe']  
...
io_config_instance.outdir="/beegfs/general/viktoria/brewster_v2/GJ499C_results/mcmc_GJ_slabsio2_deckfe_ptype7_nonuni_crh_no_inversion/"
io_config_instance.runname='mcmc_GJ_slabsio2_deckfe_ptype7_nonuni_crh_no_inversion'
